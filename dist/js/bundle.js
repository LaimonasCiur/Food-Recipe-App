...
"use strict";
eval("\n\nvar _test = __webpack_require__(/*! ./test */ \"./src/js/test.js\");\n\nvar _test2 = _interopRequireDefault(_test);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n//when we import from a module we dont even have to specify .js. We have access to what we exported from test.js module into this x variable. \nvar q = 23; // Global app controller\n//this is entry point.\n\nconsole.log('I have imported ' + _test2.default + ' from another moduwwwwwwwdwdwdwdw! Variable x is ' + q);\n//this would not work in the browser if we were not use webpack;\n//The last thing we must to do is to go to our package.json and add an npm script. 'dev' we call webpack so as soon as we start the npm script called 'dev' it will then open up webpack look up our configuration here and then do the work that we specified here. It will read our entry file, do its work and output it exactly here, as we specified.\n//why we have to use npm script for this?\n//its the best way to lunch our locally installed dev dependency, just like webpack is. \n//We need to do one more thing. which is to install the webpack command line interface. for now we have only webpack but we need something to be able to access it through the command line interface. webpack-cli --save-dev\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nconsole.log('Imported module');\nexports.default = 1000; //so if we want to export something we use export keyword and then we can have a default export and named export. This is standart way of exporting something from a module. \n//This will be saved into the x variable -> test.js\n\n//# sourceURL=webpack:///./src/js/test.js?");
